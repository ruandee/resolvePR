  ...
  return (
    <section aria-labelledby="diff-title">
      <StepIntro
        id="diff-title"
        title="The diff"
        body={<>SecPR starts from the same <code>patch</code> GitHub shows on the pull request. Added lines (marked <span style={{ color: TOKENS.diffAddStrong }}>+</span>) are the only lines the model will be asked about.</>}
        aside={
