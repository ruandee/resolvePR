...
and scanned with `resolvepr scan --local … --fixture-out`. The `generator` field records the binary and
...
```jsonc
{
  ...
  "generator": "resolvepr 0.1.0 · claude-opus-5",   // free text, shown in the demo header
  "pr": {
    "repo": "owner/name",
    "number": 142,
