...
export const TOKENS = {
  ...
  surfaceCard: 'rgba(11,11,11,0.96)',
  textPrimary: '#F4F4F4',
  textSecondary: '#A9A9A9',
  textTertiary: '#747474',
  accent: '#5B8CFF',
  accentSoft: 'rgba(91,140,255,0.14)',
  accentBorder: 'rgba(91,140,255,0.42)',
  severityCritical: '#E5484D',
  severityHigh: '#E68A3D',
  severityMedium: '#D4B33B',
  severityLow: '#78A2FF',
  diffAdd: 'rgba(91,140,255,0.14)',
  diffAddStrong: '#5B8CFF',
...
export const SEVERITY_STYLE: Record<Severity, { color: string; bg: string; border: string }> = {
  ...
  LOW:      { color: TOKENS.severityLow,      bg: 'rgba(91,140,255,0.12)', border: 'rgba(91,140,255,0.35)' },
}
