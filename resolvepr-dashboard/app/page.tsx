  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="landing-section proof-section" id="what-you-get">
        ...
        <section className="landing-section compare-section" id="why-ast">
        ...
        <section className="landing-section check-section">
        ...
        <section className="landing-section install-section" id="try-it">
